...
/*Delay = Tcy * unit (8bit max) * 10*/
//Delay10TCYx(255);
/*Delay = Tcy * unit (8bit max) * 100*/
//Delay100TCYx(255);
/*Delay = Tcy * unit (8bit max) * 1000(1K)*/
//Delay1KTCYx(200);       
/*Delay = Tcy * unit (8bit max) * 10000(10K)*/
//Delay10KTCYx(200); //Delay = 4/8MHz * 200 * 10000(10K)= 1 sec
...
//	TRISD &= 0xFF00;              // ensure RD0 - RD7 are outputs
    ...
    /* 400uS delay */
     Delay10TCYx(80);	// Delay = 0.5 * 80 * 10
}
...
The position can be anywhere between 0 and 39.
...
void LCDPos(int pos)
{
      ...
      Delay100TCYx(12);//Wait for some time to let the LCD process it
